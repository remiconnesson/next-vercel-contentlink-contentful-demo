...
import type { getPages } from "@/lib/cms";

type Pages = Awaited<ReturnType<typeof getPages>>;
...
export function HomeContent({ pages, stamp, draft }: HomeContentProps) {
  const [business, setBusiness] = useState(false);

  return (
    <main className="mx-auto max-w-4xl px-6 py-12">
      {/* Audience toggle */}
      <div className="mb-8 flex items-center justify-between gap-4 rounded-lg border bg-muted/30 px-4 py-3">
        <div className="flex flex-col">
          <span className="text-sm font-medium text-foreground">
            {business ? "Business view" : "Developer view"}
          </span>
          <span className="text-xs text-muted-foreground">
            {business
              ? "The key signals, no code."
      ...
      <div className="flex flex-col gap-4 pb-8">
        ...
        <p className="max-w-2xl text-lg text-muted-foreground leading-relaxed">
          ...
          connects your deployed site to Contentful, so editors can click any
          piece of content and jump straight to the matching field in the CMS.
        </p>
      </div>
        ...
        <>
          ...
          <section className="flex flex-col gap-6 pb-12">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <Card className="border-primary/30 bg-primary/5">
                <CardHeader>
                  ...
                  <CardTitle className="text-base">Click to edit</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription>
                    Editors click any text on the live site and land directly
                    on the right field in Contentful. No searching, no
                    guessing.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="border-primary/30 bg-primary/5">
                <CardHeader>
                  ...
                  <CardTitle className="text-base">Instant updates</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription>
                    Publish in Contentful and only the page that changed
                    refreshes -- in seconds -- while everything else keeps
                    loading fast.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="border-primary/30 bg-primary/5">
                <CardHeader>
                  ...
                  <CardTitle className="text-base">No dev handoff</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription>
                    Works automatically on Vercel previews. The team edits
                    content without filing tickets or waiting on engineering.
                  </CardDescription>
                </CardContent>
              </Card>
            </div>
            ...
            <Callout type="tip" title="The bottom line">
              <p>
                Faster content updates, fewer mistakes, and no engineering
                bottleneck -- your team ships content changes on their own.
              </p>
            </Callout>
          </section>
          ...
          <section className="flex flex-col gap-6 pb-12">
            <h2 className="text-2xl font-semibold text-foreground">
              Live content from Contentful
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              These pages come straight from your Contentful space. On a
              preview, hover any title to see the click-to-edit button.
            </p>

            {pages.length === 0 ? (
              <Callout type="warning" title="No pages found">
                <p>
                  No content entries were found in your Contentful space yet.
                </p>
              </Callout>
            ) : (
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-base">2. Vercel Toolbar</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-base">3. Click to edit</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription>
    ...
    extensions: json.extensions,
            ...
            {pages.length === 0 ? (
              <Callout type="warning" title="No pages found">
                <p>
                  ...
                  your Contentful space. Create some entries with a title, slug,
                  and body to see them listed here.
                </p>
              </Callout>
            ) : (
              <div className="grid gap-4">
          ...
          <section className="flex flex-col gap-6 pb-12">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              revalidated -- the others keep serving from cache. The generation
              stamp below proves it: edit a page in Contentful, and only that
              page&apos;s stamp changes.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              key) and one by Contentful entry ID (for the webhook). The landing
  ...
  case "cl-demo-Page":
    ...
    break;
            ...
            <div className="flex flex-col gap-3 rounded-lg border p-4">
              ...
              <ol className="flex flex-col gap-2 text-sm text-muted-foreground list-decimal pl-5 leading-relaxed">
                ...
                <li>
                  ...
                  select <strong className="text-foreground">Entry</strong>{" "}
            ...
            <Callout type="tip" title="Environment variable">
              <p>
                Make sure <code>CONTENTFUL_REVALIDATE_SECRET</code> is set in
                your Vercel project&apos;s environment variables. It can be any
                random string -- just make sure it matches the webhook header
                value.
              </p>
            </Callout>
          </section>
      ...
      <footer className="flex flex-col gap-2 pb-12 text-sm text-muted-foreground">
        <p>Built with Next.js 16, Contentful, and Vercel Content Link.</p>
        <p>
          Learn more in the{" "}
          <a
